// دالة إنشاء رابط جديد — الرمز السري يُفحص هنا في الخادم ولا يظهر أبدًا في المتصفح
...
exports.handler = async (event) => {
  ...
  // حماية من تخمين الرمز: 15 محاولة كحد أقصى لكل عنوان IP كل 5 دقائق
  ...
  // فحص الرمز السري في الخادم (PBKDF2)
  ...
  // مقارنة زمنية ثابتة تمنع هجمات التوقيت
  ...
  // إنشاء معرف عشوائي وتخزينه مع مؤقت حذف تلقائي في قاعدة البيانات
